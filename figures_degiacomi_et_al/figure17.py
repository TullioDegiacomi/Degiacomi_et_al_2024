...
QRAIN_N3_00004 = getvar(SIM_N3_00004,'QRAIN',timeidx=ALL_TIMES)
QRAIN_N3_00009 = getvar(SIM_N3_00009,'QRAIN',timeidx=ALL_TIMES)
QRAIN_N3_00012 = getvar(SIM_N3_00012,'QRAIN',timeidx=ALL_TIMES)

QRAIN_N3_00004_2000 = interplevel(QRAIN_N3_00004,z,2000)
QRAIN_N3_00009_2000 = interplevel(QRAIN_N3_00009,z,2000)
...
QRAIN_N3_00009_2000 = QRAIN_N3_00009_2000.assign_coords({'west_east' : QRAIN_N3_00009_2000.west_east.values +X2[0]+1})
QRAIN_N3_00009_2000 = QRAIN_N3_00009_2000.assign_coords({'south_north' : QRAIN_N3_00009_2000.south_north.values +X2[0]+1})
...
plot=QRAIN_N3_00004_2000[6].plot.contourf(ax=ax,levels=levels,cmap='Blues',add_colorbar=False)
#cb = plt.colorbar(plot)
QRAIN_N3_00004_2000[6].plot.contour(ax=ax,levels=levels,colors='black',alpha=0.2)
...
plt.text(528, 547.5, 'N1_00004_N3_00004', fontsize=16, verticalalignment='center',
          bbox=props)
plt.vlines(621,540,660, linestyle='dashed',color = 'black')
plt.xlim((525,675))
plt.ylim((540,660))
...
levels=[0.0004,0.0008,0.0012,0.002,0.003,0.004]
plot=QRAIN_N3_00004_2000[9].plot.contourf(ax=ax,levels=levels,cmap='Blues',add_colorbar=False)
#cb = plt.colorbar(plot)
QRAIN_N3_00004_2000[9].plot.contour(ax=ax,levels=levels,colors='black',alpha=0.2)
HGT.plot.contour(ax=ax,levels=[100,500,1000,1400,1499],colors='black',alpha=0.5)
plt.title('')
plt.text(529., 648, '(b)', fontsize=16)
#plt.vlines(627,540,660, linestyle='dashed',color = 'black')
plt.xlim((525,675))
plt.ylim((540,660))
plt.xlabel('', fontsize=18)
...
levels=[0.0004,0.0008,0.0012,0.002,0.003,0.004]
plot=QRAIN_N3_00009_2000[6].plot.contourf(ax=ax,levels=levels,cmap='Blues',add_colorbar=False)
#cb = plt.colorbar(plot)
QRAIN_N3_00009_2000[6].plot.contour(ax=ax,levels=levels,colors='black',alpha=0.2)
HGT.plot.contour(ax=ax,levels=[100,500,1000,1400,1499],colors='black',alpha=0.5)
plt.title('', y =1.03,fontsize=16)
plt.text(529., 648, '(c)',  fontsize=16)
plt.vlines(628,540,660, linestyle='dashed',color = 'black')
plt.xlim((525,675))
plt.ylim((540,660))
plt.xlabel('', fontsize=18)
plt.ylabel('$\it{y}$ [km]', fontsize=18)
props = dict(facecolor='gray', alpha=0.5)
plt.text(528, 547.5, 'N1_00004_N3_00009', fontsize=16, verticalalignment='center',
          bbox=props)


ax = plt.subplot(3, 2, 4)
levels=[0.0004,0.0008,0.0012,0.002,0.003,0.004]
plot=QRAIN_N3_00009_2000[9].plot.contourf(ax=ax,levels=levels,cmap='Blues',add_colorbar=False)
#cb = plt.colorbar(plot)
QRAIN_N3_00009_2000[9].plot.contour(ax=ax,levels=levels,colors='black',alpha=0.2)
HGT.plot.contour(ax=ax,levels=[100,500,1000,1400,1499],colors='black',alpha=0.5)
plt.title('', y =1.03,fontsize=16)
...
levels=[0.0004,0.0008,0.0012,0.002,0.003,0.004]
plot=QRAIN_N3_00012_2000[6].plot.contourf(ax=ax,levels=levels,cmap='Blues',add_colorbar=False)
#cb = plt.colorbar(plot)
QRAIN_N3_00012_2000[6].plot.contour(ax=ax,levels=levels,colors='black',alpha=0.2)
HGT.plot.contour(ax=ax,levels=[100,500,1000,1400,1499],colors='black',alpha=0.5)
plt.title('', y =1.03,fontsize=16)
plt.text(529., 648, '(e)',  fontsize=16)
plt.vlines(604,525,675, linestyle='dashed',color = 'black')
plt.xlim((525,675))
plt.ylim((540,660))
plt.xlabel('$\it{x}$ [km]', fontsize=18)
plt.ylabel('$\it{y}$ [km]', fontsize=18)
props = dict(facecolor='gray', alpha=0.5)
plt.text(528, 547.5, 'N1_00004_N3_00012', fontsize=16, verticalalignment='center',
          bbox=props)


ax = plt.subplot(3, 2, 6)
levels=[0.0004,0.0008,0.0012,0.002,0.003,0.004]
plot=QRAIN_N3_00012_2000[9].plot.contourf(ax=ax,levels=levels,cmap='Blues',add_colorbar=False)
#cb = plt.colorbar(plot)
QRAIN_N3_00012_2000[9].plot.contour(ax=ax,levels=levels,colors='black',alpha=0.2)
HGT.plot.contour(ax=ax,levels=[100,500,1000,1400,1499],colors='black',alpha=0.5)
plt.title('', y =1.03,fontsize=16)
...
plt.savefig('figure17.png', dpi=300)
